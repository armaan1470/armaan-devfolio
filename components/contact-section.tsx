    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          {/* Staggered Card */}
          <Reveal className="w-full mx-auto" delay={0.25} yOffset={20}>
            <div className="w-full max-w-5xl mx-auto">
              <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col md:flex-row gap-12 justify-between">
                {/* Contact Info */}
                ...
                {/* Contact Form */}
                <div className="flex-1 md:border-l md:border-gray-800 md:pl-12 pt-12 md:pt-0">
