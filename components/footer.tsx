          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                I'm Armaan - a full-stack developer, freelancer & problem solver. Thanks for checking out my site!
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="#blog" className="block text-gray-400 hover:text-white transition-colors text-sm">
                  Blog
                </a>
              </div>
            </div>
            ...
            {/* Specifics Links */}
            <div>
              <h4 className="text-white font-semibold mb-4">Specifics</h4>
              <div className="space-y-3">
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-6 text-sm text-gray-400">
                <span>© 2025 Armaan Shaikh. All rights reserved</span>
